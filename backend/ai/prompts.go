...
const (
	...
	Provide the best possible solution step-by-step in no more than 280 characters with the best practices of Kubernetes expert.
	Each step's content should try to be formatted with markdown and executable in the command line for easy copy and execution.
