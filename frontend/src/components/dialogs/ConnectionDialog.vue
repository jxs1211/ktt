  ...
  >
    <n-spin :show="closingConnection">
      ...
      >
        ...
        <!-- Advance pane -->
        <n-tab-pane
          :tab="$t('dialogue.connection.advn.title')"
        ...
        >
          ...
          >
            <n-grid :x-gap="10">
              ...
              <n-form-item-gi
                :label="$t('dialogue.connection.advn.key_view')"
                :span="12"
              >
              ...
              <n-form-item-gi
                :label="$t('dialogue.connection.advn.load_size')"
                :span="12"
              >
                <n-input-number
              ...
              <n-form-item-gi
                :label="$t('dialogue.connection.advn.dbfilter_type')"
                :span="24"
              >
                <n-radio-group
                ...
                >
                  <n-radio-button
                    :label="$t('dialogue.connection.advn.dbfilter_all')"
                    value="none"
                  />
                  <n-radio-button
              ...
              >
                <n-select
                  ...
                  :placeholder="
                    $t('dialogue.connection.advn.dbfilter_input_tip')
                  "
                  :show="false"
                  :show-arrow="false"
                  filterable
        ...
        <!-- Alias pane -->
        <n-tab-pane
          :tab="$t('dialogue.connection.alias.title')"
          display-directive="show:lazy"
          name="alias"
        >
          <n-form
        ...
        <!-- SSL pane -->
        <n-tab-pane
          :tab="$t('dialogue.connection.ssl.title')"
          display-directive="show:lazy"
          name="ssl"
        >
          ...
          >
            ...
            <n-form-item
              :label="$t('dialogue.connection.ssl.ca_file')"
              :show-feedback="false"
            >
              <file-open-input
            ...
            <n-form-item>
              <n-checkbox
                v-model:checked="generalForm.ssl.allowInsecure"
                size="medium"
              >
        ...
        <!-- SSH pane -->
        <n-tab-pane
          :tab="$t('dialogue.connection.ssh.title')"
          display-directive="show:lazy"
          name="ssh"
        >
          <n-form-item label-placement="left">
          ...
          >
            ...
            <n-form-item :label="$t('dialogue.connection.ssh.login_type')">
              <n-radio-group v-model:value="generalForm.ssh.loginType">
                ...
                />
                <n-radio-button
                  :label="$t('dialogue.connection.ssh.pkfile')"
                  value="pkfile"
                />
              </n-radio-group>
            </n-form-item>
            ...
            <n-form-item
              v-if="sshLoginType === 'pkfile'"
              :label="$t('dialogue.connection.ssh.passphrase')"
            >
              <n-input
        ...
        >
          <n-form-item label-placement="left">
            <n-checkbox
              v-model:checked="generalForm.sentinel.enable"
              size="medium"
            >
        ...
        <!-- Cluster pane -->
        <n-tab-pane
          :tab="$t('dialogue.connection.cluster.title')"
          display-directive="show:lazy"
          name="cluster"
        >
          <n-form-item label-placement="left">
            <n-checkbox
              v-model:checked="generalForm.cluster.enable"
              size="medium"
            >
        ...
        <!-- Proxy pane -->
        <n-tab-pane
          :tab="$t('dialogue.connection.proxy.title')"
          display-directive="show:lazy"
          name="proxy"
        >
          <n-radio-group
            v-model:value="generalForm.proxy.type"
            name="radiogroup"
          >
            <n-space size="large" vertical>
              <n-radio
                :label="$t('dialogue.connection.proxy.type_none')"
                :value="0"
              />
              <n-radio
                :label="$t('dialogue.connection.proxy.type_system')"
                :value="1"
              />
              <n-radio
                :label="$t('dialogue.connection.proxy.type_custom')"
                :value="2"
              />
              <n-form
              ...
              >
                <n-grid :x-gap="10">
                  ...
                  <n-form-item-gi :show-label="false" :span="24" path="auth">
                    <n-checkbox
                      v-model:checked="generalForm.proxy.auth"
                      size="medium"
                    >
      ...
      <n-alert
        ...
        closable
      >
        <template v-if="isEmpty(testResult)">{{
